...
- (void)updateViewWithCollectionItem:(NSDictionary *)collectionItem
{
    ...
    UIImage *arrowDownImage = [UIImage imageNamed:@"down" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil];
