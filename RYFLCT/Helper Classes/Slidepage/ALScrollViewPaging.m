...
- (void)setHasPageControl:(BOOL)hasPageControl {
    ...
    if (hasPageControl) {
        ...
        int pageControlX = scrollViewCenterPointX+20 - (pWidth / 2);
        int pageControlY = self.frame.origin.y + self.frame.size.height + -80;
        //set the frame of the page control
        [pageControl setFrame:CGRectMake(pageControlX, pageControlY, pWidth, 20)];
